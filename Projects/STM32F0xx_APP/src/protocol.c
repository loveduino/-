...
#if BOOTLOADER
#define HW_VERSION         "V0_0.1.7"          //V0表示bootloader
#elif APP_A
#define HW_VERSION         "V1_0.1.7"          //V1为设备A区运行固件
#elif APP_B
#define HW_VERSION         "V2_0.1.7"          //V2为设备B区运行固件
#endif
