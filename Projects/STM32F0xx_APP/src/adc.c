...
void prvAdcTask( void *pvParameters )
{
	...
	for( ;; )
    {
        ...
        water.raw_water_ppm = (uint16_t)((float)RegularConvData_Tab[1] / 4095  * 3.3 * 448.6486 - 111.62);
        if (water.raw_water_ppm > 999)
            water.raw_water_ppm = 0;
        
        water.clean_water_ppm = (uint16_t)((float)RegularConvData_Tab[0] / 4095  * 3.3 * 448.6486 - 111.62);
